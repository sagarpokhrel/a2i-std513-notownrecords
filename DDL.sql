...
CREATE TABLE `musicians` (
  ...
  CONSTRAINT `musicians_FK_address` FOREIGN KEY (`address_id`) REFERENCES `addresses` (`id`)
);
...
CREATE TABLE `albums` (
  ...
  CONSTRAINT `albums_FK_producer` FOREIGN KEY (`producer_id`) REFERENCES `musicians` (`ssn`)
);
...
CREATE TABLE `songs` (
  ...
  CONSTRAINT `songs_FK_album` FOREIGN KEY (`album_id`) REFERENCES `albums` (`id`)
  CONSTRAINT `songs_FK_musician` FOREIGN KEY (`author_id`) REFERENCES `musicians` (`ssn`)
);
...
CREATE TABLE `song_instruments` (
  ...
  CONSTRAINT `song_instruments_FK_song` FOREIGN KEY (`song_id`) REFERENCES `songs` (`id`)
);
